...
public class RechargeRequestJson {
	private Long id;
	...
	public RechargeRequestJson(RechargeRequest request) {
		this(request.getId(), 
	...
	public RechargeRequestJson(Long id, Long userId, String userName,String userMobile,Long requestTypeId,String requestTypeName,
