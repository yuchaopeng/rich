...
<head>
	...
	<script type="text/javascript" src="/res/js/withdraw/withdrawRequestList.js"></script>
</head>
<body>
	<div style="padding:5px;">
		<form action="" id="searchWithdrawForm" method="post">
			<div class="easyui-panel" title="查询条件" style="padding:10px">
				<table>
					...
					<tr>
						...
						<td class="td_label">
							<a href="javascript:searchWithdrawForm()" class="easyui-linkbutton" data-options="iconCls:'icon-search'" style="width:80px">查询</a>
							<a href="javascript:resetWithdrawForm()" class="easyui-linkbutton" data-options="iconCls:'icon-reload'" style="width:80px">重置</a>
						</td>
					</tr>
				</table>
			</div>
		</form>
		<table id="withdraw_request_list">
		</table>
	</div>
</body>
</html>